  ...
  return (
    <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
        ...
        <Button variant="contained" color="primary" style={{ fontWeight: 'bold' }}>Add User</Button>
      </div>
        ...
        <Table>
          <TableHead style={{ backgroundColor: '#1976d2' }}>
            <TableRow>
              ...
              <TableCell style={{ color: 'white', fontWeight: 'bold' }}>Tasks</TableCell>
          ...
          <TableBody>
            {filteredUsers.map((userEntry, index) => (
              <TableRow key={userEntry.id} style={{ backgroundColor: index % 2 === 0 ? '#f5f5f5' : 'white' }}>
