...
const clubs = [
    { id: "67d261f783c50d6c7df9dd50", name: "New Jersey Club", description: "Premium coaching and top-tier facilities.",image:{pickleball1}, bgColor: "#ffcccb" },
    { id: "67d2620383c50d6c7df9dd51", name: "Houston Club", description: "A great place for community play and tournaments.",image:{pickleball3}, bgColor: "#d1e7dd" },
    { id: "67d2cc08c1534675fa24ff39", name: "Manchester-pickball", description: "Train like a pro with experienced instructors.",image:{pickleball4}, bgColor: "#cce5ff" }
  ];
    ...
    return (
        ...
        <div className="button-group">
            <p>{clubName}</p>
              ...
              <button className="btn" onClick={() => navigate(`/clubs/${id}/authentication`, { state: { clubName } })}>Authenticate</button>
            </div>
